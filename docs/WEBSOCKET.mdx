...
sequenceDiagram
    ...
    participant Reader as Reader Loop
    participant Channel
    ...
    Note over Writer,Reader: Both run concurrently<br/>until connection closed
    
    style Conn fill:#764ba2,color:#fff
    style Writer fill:#28a745,color:#fff
    style Reader fill:#3498db,color:#fff
...
graph TB
    subgraph "Server to Client"
        Poller[Poller/Service] -->|data| Channel[Shared Channel<br/>capacity: 100]
    ...
    style Writer fill:#667eea,stroke:#333,stroke-width:2px,color:#fff
    style Reader fill:#3498db,stroke:#333,stroke-width:2px,color:#fff
    style Client1 fill:#f39c12,stroke:#333,stroke-width:2px,color:#fff
    style Client2 fill:#f39c12,stroke:#333,stroke-width:2px,color:#fff
```
